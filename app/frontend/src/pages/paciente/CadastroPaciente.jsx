  ...
  return (
    <div className="min-h-screen bg-surface-container-low flex flex-col items-center justify-center p-4 text-on-surface">
      ...
      <div className="w-full max-w-lg mb-6 text-center">
        <div className="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/30 mx-auto mb-4">
          <span className="material-symbols-outlined text-on-primary text-2xl">health_and_safety</span>
        </div>
        <h1 className="text-2xl font-extrabold tracking-tight text-on-background">Gestão Saúde UBS+</h1>
